...
router.get("/", (req, res, next) => {
  ...
  let students = {
      list: [
        ...
        { "id": 7, "ชื่อขนมไทย": "เม็ดขนุน","หมายถึง": "มีคนช่วยสนับสนุนค้ำจุนในหน้าที่การงาน การดำเนินชีวิต ไม่ว่าจะประกอบกิจการใดๆ ก็จะประสบผลสำเร็จ","นิยม": "ให้เพื่อค้ำจุน" ,"สี": "สีเหลืองทอง เพื่อความเป็นสิริมงคล" },
        { "id": 8, "ชื่อขนมไทย": "ดาราทอง","หมายถึง": "หัวหน้าผู้เป็นใหญ่","นิยม": "ให้ผู้ที่ได้รับการยกย่องอย่างสูงเนื่องจากมีวิธีทำที่ค่อนข้างยาก" ,"สี": "เหลืองทองทีแผ่นทองคำเปลวประดับตกแต่ง" },
        { "id": 9, "ชื่อขนมไทย": "ถ้วยฟู","หมายถึง": "ความเป็นสิริมงคลและความเจริญก้าวหน้าของชีวิตคู่ หรืออวยพรให้รุ่งเรืองเฟื่องฟูเหมือนขนมถ้วยฟู","นิยม": "ใช้ในงานมงคลต่างๆ นำมาใช้ในพิธีแต่งงาน" ,"สี": "มีหลากหลายสีสัน เช่น ชมพู เหลือง เขียว ฟ้า ขาว แดง" },
        ...
        { "id": 11, "ชื่อขนมไทย": "กงหรือขนมกงเกวียน","หมายถึง": "การอวยพรให้บ่าวสาวครองรักกันชั่วนิรันดร์","นิยม": "ให้ในงานมงคลเพื่ออวยพรให้บ่าวสาว" ,"สี": "น้ำตาล" },
        { "id": 12, "ชื่อขนมไทย": "สามเกลอ","หมายถึง": "ความสามัคคีและไม่มีวันพรากจากกัน","นิยม": "ใช้เป็นขนมเสี่ยงทายในงานแต่ง" ,"สี": "หลากหลายสี" },
        { "id": 13, "ชื่อขนมไทย": "ข้าวเหนียวแก้ว","หมายถึง": "จะมีแต่ความเหนียวแน่น เป็นปึกแผ่นมั่นคง","นิยม": "ใช้ในงานมงคลชีวิต" ,"สี": "เหลือง ชมพู" }
      ]
    }
